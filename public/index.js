...
const isToday = (date) => {
    ...
    // установка значений полей для раздела прогноза погоды
...
const switcherTexts = ['Ввести широту и долготу от души', 'Ввести название и код города'];
